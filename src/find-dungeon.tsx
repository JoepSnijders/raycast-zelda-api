...
const getDungeonData = (page: Number) => {
    const response = useFetch<Response>(`https://zelda.fanapis.com/api/dungeons?limit=1000&page=` + page);
...
export default function Command() {
    ...
    for (let i = 0; i < 9; i++) {
        let pageData = getDungeonData(i);
        combinedData = [...combinedData, ...(pageData?.data as any[])];
    }
